...
async function loadHomeData(el, index) {
    ...
    if (sub === "Cats") {
        const catMap = {
            1: { n: "Grey cat by the entrance to the instance.", i: "https://wiki.guildwars2.com/images/e/ee/Slab_of_Poultry_Meat.png" },
            2: { n: "Grey cat by the entrance to the instance.", i: "https://wiki.guildwars2.com/images/9/95/Grilled_Poultry.png" },
            3: { n: "Orange cat near the harvesting nodes.", i: "https://wiki.guildwars2.com/images/3/35/Spicy_Flank_Steak.png" },
            4: { n: "Orange cat near the harvesting nodes.", i: "https://wiki.guildwars2.com/images/0/01/Spicier_Flank_Steak.png" },
            5: { n: "Orange cat near the harvesting nodes.", i: "https://wiki.guildwars2.com/images/2/27/Plate_of_Fire_Flank_Steak.png" },
            6: { n: "Black cat playing with a snowball.", i: "https://wiki.guildwars2.com/images/f/f0/Bowl_of_Prickly_Pear_Sorbet.png" },
            7: { n: "Black cat playing with a snowball.", i: "https://wiki.guildwars2.com/images/9/97/Bowl_of_Ginger-Lime_Ice_Cream.png" },
            8: { n: "Black cat playing with a snowball.", i: "https://wiki.guildwars2.com/images/8/8c/Bowl_of_Saffron-Mango_Ice_Cream.png" },
            9: { n: "Black cat playing with a snowball.", i: "https://wiki.guildwars2.com/images/9/92/Bowl_of_Peach_Raspberry_Swirl_Ice_Cream.png" },
            10: { n: "Black kitten that only appears if the instance is entered during day.", i: "https://wiki.guildwars2.com/images/e/ee/Slab_of_Poultry_Meat.png" },
            11: { n: "White kitten that only appears if the instance is entered during night.", i: "https://wiki.guildwars2.com/images/e/ee/Slab_of_Poultry_Meat.png" },
            12: { n: "Black cat that fights other cats.", i: "https://wiki.guildwars2.com/images/1/11/Cheeseburger.png" },
            13: { n: "Black cat that fights other cats.", i: "https://wiki.guildwars2.com/images/e/e7/Tonic.png" },
            14: { n: "Black cat that fights other cats with a Juvenile Frog.", i: "https://wiki.guildwars2.com/images/1/1f/Vanilla_Bean.png" },
            15: { n: "Black cat that fights other cats.", i: "https://wiki.guildwars2.com/images/c/ca/Bowl_of_Curry_Mussel_Soup.png" },
            16: { n: "Black cat that fights other cats.", i: "https://wiki.guildwars2.com/images/a/a1/Slice_of_Rainbow_Cake.png" },
            17: { n: "Black cat that fights other cats.", i: "https://wiki.guildwars2.com/images/7/71/Flask_of_Pumpkin_Oil.png" },
            18: { n: "Black cat that fights other cats.", i: "https://wiki.guildwars2.com/images/c/c3/Carrot.png" },
            19: { n: "Black cat that fights other cats.", i: "https://wiki.guildwars2.com/images/4/4c/Harpy_Feathers.png" },
            20: { n: "Black cat that fights other cats.", i: "https://wiki.guildwars2.com/images/b/b8/Grumble_Cake.png" },
            21: { n: "Orange cat near the harvesting nodes.", i: "https://wiki.guildwars2.com/images/2/27/Plate_of_Fire_Flank_Steak.png" },
            22: { n: "Orange cat near the harvesting nodes.", i: "https://wiki.guildwars2.com/images/f/f0/Ghost_Pepper.png" },
            23: { n: "Feline Familiar near the Raw Candy Corn node.", i: "https://wiki.guildwars2.com/images/1/13/Frog_in_a_Jar.png" },
            24: { n: "Snow Leopard Cub that follows you around the instance.", i: "https://wiki.guildwars2.com/images/3/3a/Snow_Leopard_Cub.jpg" },
            25: { n: "Orange cat by a Pot of Cat-Made Soup.", i: "https://wiki.guildwars2.com/images/f/f9/Bowl_of_Lemongrass_Poultry_Soup.png" },
            26: { n: "Orange cat by a Pot of Cat-Made Soup.", i: "https://wiki.guildwars2.com/images/0/05/Bowl_of_Poultry_and_Winter_Vegetable_Soup.png" },
            27: { n: "Orange cat by a Pot of Cat-Made Soup.", i: "https://wiki.guildwars2.com/images/b/ba/Bowl_of_Poultry_and_Leek_Soup.png" },
            28: { n: "Orange cat by a Pot of Cat-Made Soup.", i: "https://wiki.guildwars2.com/images/5/5a/Bowl_of_Simple_Poultry_Soup.png" },
            29: { n: "Lady Wisteria Whiskington near the Bloodstone Crystals", i: "https://wiki.guildwars2.com/images/1/14/Bowl_of_Bloodstone_Bisque.png" },
            32: { n: "Light blue Ghostly Cat.", i: "https://wiki.guildwars2.com/images/2/25/Strawberry_Ghost.png" },
            33: { n: "Yellow cat with black stripes with a blue Bauble necklace and blue cubes aura.", i: "/Assets/Icons/bee_dog_sab.png" },
            34: { n: "Holographic Kitten", i: "https://wiki.guildwars2.com/images/d/d7/Gold_coin_%28highres%29.png" },
            35: { n: "Simon, the celestial cat.", i: "https://wiki.guildwars2.com/images/f/f6/Integrated_Fractal_Matrix.png" },
            36: { n: "Blue Catmander", i: "https://wiki.guildwars2.com/images/2/25/Gift_of_Battle.png" },
            37: { n: "Yellow Catmander", i: "https://wiki.guildwars2.com/images/8/80/Can_of_Spicy_Meat_Chili.png" }
        };
        ...
        const nodeImages = {
            ...
            "enchanted_treasure_chest": { n: "Enchanted Treasure Chest", i: "https://wiki.guildwars2.com/images/8/81/Enchanted_Treasure_Chest.png" },
            ...
            "garden_plot_01": { n: "garden_plot_01", i: "https://wiki.guildwars2.com/images/e/e9/Black_Lion_Garden_Plot_Deed.png" },
            "garden_plot_02": { n: "garden_plot_02", i: "https://wiki.guildwars2.com/images/e/e9/Black_Lion_Garden_Plot_Deed.png" },
            "garden_plot_03": { n: "garden_plot_03", i: "https://wiki.guildwars2.com/images/e/e9/Black_Lion_Garden_Plot_Deed.png" },
